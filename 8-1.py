inpt = ["zjrfcpbktjmrzgsz\xcaqsc\x03n\"huqab",
"daz\\zyyxddpwk",
...
for x in xrange(len(inpt)):
    currLine = inpt[x]
    for y in xrange(1, len(currLine)-2):
        print("curr =",currLine[y], currLine[y+1] + currLine[y+2])
        if currLine[y] == 'x' and currLine[y-1] == '\\':
            print("X Found")
            if ((currLine[y+1] <= '9') or (currLine[y+1] == 'a') or (currLine[y+1] == 'b') or (currLine[y+1] == 'c') or (currLine[y+1] == 'd') or (currLine[y+1] == 'e') or (currLine[y+1] == 'f')):
                print("First Good")
                if ((currLine[y+2] <= '9') or (currLine[y+2] == 'a') or (currLine[y+2] == 'b') or (currLine[y+2] == 'c') or (currLine[y+2] == 'd') or (currLine[y+2] == 'e') or (currLine[y+2] == "f")): 
                    print("Second Good")
                    hexCtr += 1
                    print("Hexbyte =",currLine[y+1] + currLine[y+2])

print("Hex =", hexCtr)

for x in xrange(len(inpt)):
    currLine = inpt[x]
    for y in xrange(len(currLine)):
        memChars += 1
print(6489-memChars)
